...
class PublicOfficeComuneGuidanceDefinitions {
  static final RichCategoryGuidance category = RichCategoryGuidance.fromMap({
    ...
    'topWarning':
        'Do not show all offices, all certificate types, all templates, and all contacts on one page. Ask the user what they need first, then show only the relevant Comune/Anagrafe flow.',
    'officialReferences': {
    ...
    'channelRules': [
      ...
      },
      {
        ...
        'warning': 'Verify office hours and appointment requirement before going.',
      },
      {
        'id': 'appointment',
    ...
    'commonDocuments': [
      ...
      {'id': 'hospitality_declaration', 'label': 'Hospitality declaration', 'labelIt': 'Dichiarazione di ospitalità'},
      {'id': 'property_deed', 'label': 'Property deed / ownership proof', 'labelIt': 'Atto di proprietà / prova proprietà'},
      {'id': 'permesso_soggiorno', 'label': 'Permesso di soggiorno if non-EU', 'labelIt': 'Permesso di soggiorno se extra-UE'},
      {'id': 'passport_or_eu_id', 'label': 'Passport or EU ID card if foreign citizen', 'labelIt': 'Passaporto o documento UE se cittadino straniero'},
      {'id': 'protocol_number', 'label': 'Protocol number', 'labelIt': 'Numero di protocollo'},
      {'id': 'rejection_message', 'label': 'Rejection/suspension message', 'labelIt': 'Messaggio di rigetto/sospensione'},
      {'id': 'spid_cie_cns', 'label': 'SPID / CIE / CNS', 'labelIt': 'SPID / CIE / CNS'},
      {'id': 'proof_of_address', 'label': 'Proof of address', 'labelIt': 'Prova dell’indirizzo'},
      {'id': 'doorbell_mailbox_photo', 'label': 'Doorbell/mailbox photo', 'labelIt': 'Foto citofono/cassetta postale'},
      {'id': 'marca_da_bollo', 'label': 'Marca da bollo if required', 'labelIt': 'Marca da bollo se richiesta'},
      {'id': 'delegation', 'label': 'Delegation if requesting for another person', 'labelIt': 'Delega se richiedi per un’altra persona'},
    ],
    'firstScreenQuestions': [
      {
        ...
        'options': [
          ...
          {'id': 'move_to_torino', 'label': 'I moved to Torino from another Comune or abroad'},
          {'id': 'move_inside_torino', 'label': 'I changed address inside Torino'},
          {'id': 'temporary_stay', 'label': 'I am only temporarily living in Torino'},
          {'id': 'residenza_rejected', 'label': 'My residenza request was rejected/suspended'},
          {'id': 'certificate_general', 'label': 'I need an Anagrafe certificate'},
          {'id': 'stato_famiglia', 'label': 'I need stato di famiglia'},
          {'id': 'residence_certificate', 'label': 'I need certificato di residenza'},
          ...
          {'id': 'doorbell_address_proof', 'label': 'I need doorbell/mailbox/address proof help'},
      ...
      },
      {
        ...
        'question': 'Do you have rental contract, ownership proof, or hospitality declaration?',
        'questionIt': 'Hai contratto di affitto, proprietà o dichiarazione di ospitalità?',
        'type': 'single_choice',
        'options': [
    ...
    'subcategories': [
      {
        ...
        'documents': ['identity_document', 'codice_fiscale', 'rental_contract', 'hospitality_declaration', 'permesso_soggiorno'],
        'extraDocuments': [
        ...
        'warnings': [
          ...
          'If the user only needs proof for an Italian public office, autocertificazione may be enough.',
          'If the user is temporarily living in Torino without transferring habitual residence, temporary residence may be more appropriate.',
        ],
        'outputs': [
      ...
      },
      {
        ...
        'recommendedChannels': ['comune_online_service', 'normal_email', 'pec_formal', 'appointment'],
        'recommendedContacts': ['anagrafeTorinoGeneral', 'comuneAppointmentService'],
        'documents': ['identity_document', 'codice_fiscale', 'rental_contract', 'hospitality_declaration', 'property_deed', 'permesso_soggiorno', 'passport_or_eu_id'],
        'extraDocuments': [
          'Declaration form',
          'Address details: street, number, internal, floor, staircase',
      ...
      },
      {
        ...
        'recommendedChannels': ['comune_online_service', 'normal_email', 'pec_formal', 'appointment'],
        'recommendedContacts': ['anagrafeTorinoGeneral', 'comuneAppointmentService'],
        'documents': ['identity_document', 'codice_fiscale', 'rental_contract', 'hospitality_declaration', 'property_deed', 'permesso_soggiorno'],
        'extraDocuments': [
        ...
        'outputs': ['change_address_checklist', 'comune_online_service_guide', 'email_to_anagrafe_procedure_documents', 'pec_missing_documents_integration'],
      },
      {
        ...
        'recommendedChannels': ['normal_email', 'pec_formal', 'appointment', 'in_person_anagrafe'],
        'recommendedContacts': ['residenzaTemporaneaTorino', 'anagrafeTorinoGeneral'],
        'documents': ['identity_document', 'codice_fiscale', 'rental_contract', 'hospitality_declaration', 'permesso_soggiorno', 'passport_or_eu_id'],
        'extraDocuments': ['Proof of temporary stay', 'Reason for temporary stay', 'Permanent residence address elsewhere', 'Any form required by Comune'],
        'warnings': [
        ...
        'outputs': ['temporary_residence_checklist', 'temporary_residence_email', 'temporary_residence_pec_checklist', 'temporary_residence_appointment_request'],
      },
      {
        ...
        'priority': 'medium',
        'whatIsIt': 'This page helps users prepare for residence checks and proof of address.',
        'whyDoYouNeedIt': [
        ...
        'documents': ['rental_contract', 'hospitality_declaration', 'identity_document', 'doorbell_mailbox_photo', 'proof_of_address'],
        'extraDocuments': ['Landlord/host ID if relevant', 'Address details', 'Messages with landlord/host', 'Condominium/administrator confirmation if available'],
        'warnings': [
        ...
        'outputs': ['doorbell_mailbox_checklist', 'message_to_landlord_host', 'address_proof_checklist', 'residence_check_preparation'],
      },
      {
        ...
        'recommendedContacts': ['anagrafeTorinoGeneral'],
        'documents': ['rejection_message', 'protocol_number', 'identity_document', 'codice_fiscale', 'rental_contract', 'hospitality_declaration', 'permesso_soggiorno', 'doorbell_mailbox_photo'],
        'extraDocuments': ['Any missing documents requested by Comune', 'Proof of address', 'Messages with landlord/host', 'Updated form if required'],
        'warnings': [
          'Use PEC for formal integration/reply when possible.',
          'If the user does not understand what is missing, send normal email first asking clarification.',
        ],
        'outputs': ['pec_residenza_integration', 'email_ask_missing_documents', 'rejected_residenza_reply', 'residenza_rejection_document_checklist'],
      },
      {
        ...
        'priority': 'high',
        'whatIsIt': 'This page helps users request official demographic/anagrafe certificates.',
        'whyDoYouNeedIt': [
        ...
        'recommendedChannels': ['anpr_online', 'in_person_anagrafe', 'appointment'],
        'recommendedContacts': ['anpr', 'anagrafeTorinoGeneral', 'historicCertificatesTorino'],
        'documents': ['identity_document', 'codice_fiscale', 'spid_cie_cns', 'marca_da_bollo', 'delegation'],
        'extraDocuments': ['Reason/use of certificate', 'Recipient office/company/authority', 'Data of person certificate refers to', 'Historical period if historical certificate'],
        'warnings': [
        ...
        'outputs': ['certificate_request_checklist', 'anpr_guide', 'in_person_certificate_checklist', 'appointment_checklist', 'email_which_certificate_needed'],
      },
      {
        ...
        'whyDoYouNeedIt': ['ISEE', 'benefits', 'school or university procedures', 'housing', 'bank or insurance', 'foreign documents', 'public-office request'],
        'recommendedChannels': ['anpr_online', 'in_person_anagrafe', 'appointment'],
        'recommendedContacts': ['anpr', 'anagrafeTorinoGeneral'],
        'documents': ['spid_cie_cns', 'identity_document', 'codice_fiscale', 'marca_da_bollo'],
        'extraDocuments': ['Reason/use', 'Recipient office/company/authority', 'Delegation if requesting for another person'],
        'warnings': [
        ...
        'outputs': ['stato_famiglia_checklist', 'anpr_download_guide', 'autocertificazione_alternative_warning'],
      },
      {
        ...
        'priority': 'medium',
        'whatIsIt': 'This certificate proves where a person is officially resident.',
        'whyDoYouNeedIt': ['Bank', 'employer', 'foreign authority', 'school/university', 'housing procedure', 'private company', 'some public-office cases'],
        'recommendedChannels': ['anpr_online', 'in_person_anagrafe', 'appointment'],
        'recommendedContacts': ['anpr', 'anagrafeTorinoGeneral'],
        'documents': ['spid_cie_cns', 'identity_document', 'codice_fiscale', 'marca_da_bollo'],
        'extraDocuments': ['Reason/use', 'Recipient office/company/authority', 'Delegation if requesting for another person'],
        'warnings': [
          ...
          'If the user is not officially resident at that address yet, certificate will not solve the issue; route to residenza/cambio indirizzo.',
        ],
        'outputs': ['residence_certificate_checklist', 'anpr_download_guide', 'autocertificazione_alternative', 'appointment_checklist'],
      },
      {
        ...
        'extraDocuments': ['Correct personal data to declare', 'Recipient office', 'Reason/use'],
        'warnings': [
        ...
        'outputs': ['autocertificazione_template', 'when_not_to_use_autocertificazione', 'certificate_vs_self_certification_explanation'],
      },
      {
        ...
        'priority': 'medium',
        'whatIsIt': 'This page helps users book an appointment with Comune/Anagrafe.',
        'whyDoYouNeedIt': [
        ...
        'recommendedContacts': ['comuneAppointmentService', 'anagrafeTorinoGeneral'],
        'documents': ['identity_document', 'codice_fiscale', 'protocol_number'],
        'extraDocuments': ['Type of service needed', 'Relevant documents for appointment', 'Existing protocol number if any', 'Screenshot/error if online problem'],
        'warnings': ['Some offices may offer remote/online appointments.', 'Verify the service and office before going.'],
        'outputs': ['appointment_checklist', 'email_appointment_help', 'what_to_bring_checklist'],
      },
      {
        ...
        'priority': 'medium',
        'whatIsIt': 'This page helps users write a formal request to Comune/Anagrafe.',
        'whyDoYouNeedIt': ['Missing document integration', 'Follow-up on protocol', 'Request clarification', 'Complaint about blocked practice', 'Formal appointment request', 'Rejected request reply'],
        'recommendedChannels': ['pec_formal', 'normal_email'],
        'recommendedContacts': ['anagrafeTorinoGeneral'],
        'documents': ['protocol_number', 'identity_document', 'codice_fiscale', 'rejection_message'],
        'extraDocuments': ['Relevant attachments', 'Previous Comune message', 'Proof of submission', 'Clear description of request'],
        'warnings': ['Use PEC for formal/protocol communication.', 'Use normal email for simple information requests.'],
        'outputs': ['comune_pec_template', 'normal_email_template', 'followup_protocol_template', 'missing_document_integration_template'],
      },
      {
        ...
        'priority': 'medium',
        'whatIsIt': 'This page helps users report problems with Torino online Comune/Anagrafe services.',
        'whyDoYouNeedIt': ['SPID login problem', 'service error', 'upload not working', 'appointment booking error', 'form blocked', 'payment problem', 'cannot download certificate', 'residenza request stuck'],
        'recommendedChannels': ['normal_email', 'appointment'],
        'recommendedContacts': ['anagrafeTorinoGeneral', 'comuneAppointmentService'],
        'documents': ['screenshots', 'protocol_number', 'identity_document', 'codice_fiscale'],
        'extraDocuments': ['Screenshot of error', 'Date/time', 'SPID/CIE method used', 'Service name', 'Browser/device information'],
        'warnings': ['Do not send sensitive passwords or SPID credentials.', 'Include screenshots and exact service name.'],
        'outputs': ['technical_issue_report', 'screenshot_checklist', 'email_to_anagrafe_support'],
      },
      {
        ...
        'priority': 'low',
        'whatIsIt': 'This page helps users ask Comune/Anagrafe what to do when they are unsure.',
        'whyDoYouNeedIt': ['User is unsure which procedure applies', 'User has mixed residence/certificate/document problem', 'User needs to ask which documents to prepare', 'User needs office/contact direction'],
        'recommendedChannels': ['normal_email', 'pec_formal'],
        'recommendedContacts': ['anagrafeTorinoGeneral'],
        'documents': ['identity_document', 'codice_fiscale', 'protocol_number'],
        'extraDocuments': ['Short description of case', 'Address', 'Relevant attachments', 'Previous protocol if any'],
        'warnings': ['Use normal email for information.', 'Use PEC only if formal/protocol communication is needed.'],
        'outputs': ['short_information_request_email', 'formal_pec_if_needed', 'appointment_request'],
      },
    ],
    'outputGenerators': [
      {'id': 'correct_procedure_recommendation', 'title': 'Correct procedure recommendation', 'titleIt': 'Consiglio sulla procedura corretta', 'outputType': 'guided_summary', 'templateBehavior': 'Based on the user’s answers, explain whether they need ordinary residenza, change address inside Torino, temporary residence, certificate, self-certification, appointment, or PEC/formal request.'},
      {'id': 'comune_document_checklist', 'title': 'Comune document checklist', 'titleIt': 'Checklist documenti Comune', 'outputType': 'checklist', 'items': ['Identity document', 'Codice fiscale', 'Rental contract / property proof / hospitality declaration', 'Address details', 'Permesso di soggiorno if non-EU', 'Passport or EU ID if foreign citizen', 'Protocol number if existing practice', 'Any Comune message if request is blocked/rejected']},
      {'id': 'residence_change_checklist', 'title': 'Residence change checklist', 'titleIt': 'Checklist cambio residenza', 'outputType': 'checklist', 'items': ['Identity document', 'Codice fiscale', 'Rental contract, ownership proof, or hospitality declaration', 'Complete address: street, number, internal, floor, staircase', 'Data of all people moving', 'Permesso di soggiorno if non-EU', 'Passport/EU ID if foreign citizen', 'Doorbell/mailbox name visible', 'Vehicle plate/driving details if requested', 'Submit after actually moving into the home'], 'warning': 'Comune di Torino states residence change after moving must be declared within 20 days.'},
      {'id': 'email_to_anagrafe_procedure_documents', 'title': 'Email asking Anagrafe procedure/documents', 'titleIt': 'Email per chiedere procedura/documenti all’Anagrafe', 'outputType': 'email', 'sendTo': 'info.anagrafe@comune.torino.it', 'templateIt': 'Oggetto: Richiesta informazioni su pratica anagrafica\n\nBuongiorno,\n\nvorrei chiedere informazioni sulla procedura corretta per [cambio residenza / cambio indirizzo / certificato / altro].\n\nLa mia situazione è la seguente:\n- Nome e cognome: [nome]\n- Cittadinanza: [italiana/UE/extra-UE]\n- Indirizzo attuale: [indirizzo]\n- Nuovo indirizzo, se applicabile: [indirizzo]\n- Sono già residente a Torino: [sì/no]\n- Documenti disponibili: [contratto affitto / ospitalità / permesso / altro]\n\nVorrei sapere quale procedura devo seguire e quali documenti devo preparare.\n\nCordiali saluti,\n[Nome Cognome]\n[Telefono]'},
      {'id': 'pec_missing_documents_integration', 'title': 'PEC missing documents integration', 'titleIt': 'PEC integrazione documenti mancanti', 'outputType': 'pec', 'sendTo': 'Servizi.Civici@cert.comune.torino.it', 'templateIt': 'Oggetto: Integrazione documenti pratica anagrafica - Protocollo [numero]\n\nBuongiorno,\n\nin riferimento alla pratica anagrafica relativa a [tipo pratica], presentata in data [data], protocollo [numero protocollo], invio in allegato la documentazione integrativa richiesta.\n\nDocumenti allegati:\n[elenco documenti]\n\nChiedo cortesemente di confermare la ricezione e di procedere con la valutazione della pratica.\n\nCordiali saluti,\n[Nome Cognome]\nCodice fiscale: [codice fiscale]\nTelefono: [telefono]\nEmail: [email]'},
      {'id': 'doorbell_mailbox_checklist', 'title': 'Doorbell/mailbox checklist', 'titleIt': 'Checklist citofono/cassetta postale', 'outputType': 'checklist', 'items': ['Name visible on doorbell', 'Name visible on mailbox', 'Correct street number', 'Correct internal/floor/staircase', 'Landlord/host aware of possible residence check', 'Photo of doorbell/mailbox', 'Rental contract or hospitality declaration ready'], 'warning': 'Residence checks may fail if Comune/police cannot find the person at the declared address.'},
      {'id': 'message_to_landlord_host', 'title': 'Message to landlord/host', 'titleIt': 'Messaggio a proprietario/ospitante', 'outputType': 'message', 'recipient': 'landlord_or_host', 'templateIt': 'Buongiorno,\n\nper completare la pratica di residenza/cambio indirizzo ho bisogno che il mio nome sia visibile sul citofono e sulla cassetta postale dell’abitazione in [indirizzo].\n\nPuò aiutarmi ad aggiungerlo o indicarmi come procedere con il condominio/amministratore?\n\nGrazie,\n[Nome]'},
      {'id': 'temporary_residence_checklist', 'title': 'Temporary residence checklist', 'titleIt': 'Checklist residenza temporanea', 'outputType': 'checklist', 'items': ['Identity document', 'Codice fiscale', 'Proof of temporary stay in Torino', 'Rental contract or hospitality declaration', 'Reason for temporary stay', 'Permanent residence address elsewhere', 'Permesso di soggiorno if non-EU', 'Passport/ID if foreign citizen', 'Send to residenzatemporanea@comune.torino.it or PEC, or request appointment']},
      {'id': 'temporary_residence_email', 'title': 'Temporary residence email', 'titleIt': 'Email residenza temporanea', 'outputType': 'email', 'sendTo': 'residenzatemporanea@comune.torino.it', 'templateIt': 'Oggetto: Richiesta iscrizione registro popolazione temporanea\n\nBuongiorno,\n\nvorrei richiedere informazioni / presentare richiesta di iscrizione nel registro della popolazione temporanea del Comune di Torino.\n\nLa mia situazione è la seguente:\n- Nome e cognome: [nome]\n- Codice fiscale: [codice fiscale]\n- Cittadinanza: [italiana/UE/extra-UE]\n- Residenza permanente: [Comune/Paese]\n- Domicilio temporaneo a Torino: [indirizzo]\n- Motivo della permanenza temporanea: [studio/lavoro/altro]\n- Periodo previsto: [date]\n\nAllego / posso allegare: [documenti].\n\nChiedo cortesemente indicazioni sulla documentazione necessaria e sulla modalità di presentazione.\n\nCordiali saluti,\n[Nome Cognome]\n[Telefono]'},
      {'id': 'rejected_residenza_reply', 'title': 'Rejected residenza reply', 'titleIt': 'Risposta a residenza respinta/sospesa', 'outputType': 'pec_or_email', 'sendTo': 'Servizi.Civici@cert.comune.torino.it', 'templateIt': 'Oggetto: Richiesta riesame / integrazione pratica residenza - Protocollo [numero]\n\nBuongiorno,\n\ncon riferimento alla mia pratica di [residenza / cambio indirizzo], protocollo [numero], ho ricevuto comunicazione di [rigetto / sospensione / richiesta integrazione] per il seguente motivo: [motivo indicato].\n\nCon la presente invio la documentazione aggiornata/integrativa:\n[elenco documenti]\n\nChiedo cortesemente il riesame della pratica e resto disponibile per eventuali ulteriori chiarimenti.\n\nCordiali saluti,\n[Nome Cognome]\nCodice fiscale: [codice fiscale]\nTelefono: [telefono]\nEmail: [email]'},
      {'id': 'certificate_request_checklist', 'title': 'Certificate request checklist', 'titleIt': 'Checklist richiesta certificato', 'outputType': 'checklist', 'items': ['Identify exact certificate needed', 'Check if ANPR can issue it online', 'SPID/CIE/CNS for online request', 'Identity document and codice fiscale', 'Check if marca da bollo is required', 'Check if autocertificazione is enough for Italian public office', 'For historical certificates, use specific Comune channel if needed']},
      {'id': 'anpr_guide', 'title': 'ANPR guide', 'titleIt': 'Guida ANPR', 'outputType': 'info_card', 'contentIt': 'Per molti certificati anagrafici attuali puoi usare ANPR con SPID/CIE/CNS. Accedi al portale ANPR, scegli il certificato, verifica eventuale bollo, scarica il PDF e conserva il file. Se il certificato è storico o non disponibile online, usa i canali del Comune.'},
      {'id': 'autocertificazione_template', 'title': 'Autocertificazione template', 'titleIt': 'Modello autocertificazione', 'outputType': 'document_template', 'templateIt': 'DICHIARAZIONE SOSTITUTIVA DI CERTIFICAZIONE\n\nIo sottoscritto/a [Nome Cognome], nato/a a [luogo] il [data], codice fiscale [codice fiscale], residente in [indirizzo], consapevole delle responsabilità previste in caso di dichiarazioni false,\n\nDICHIARO\n\n[contenuto della dichiarazione: residenza / stato di famiglia / altro]\n\nLa presente dichiarazione è resa per uso [indicare uso/destinatario].\n\nLuogo e data: [luogo, data]\nFirma: [firma]\n\nAllego copia del documento d’identità se richiesto.'},
      {'id': 'when_not_to_use_autocertificazione', 'title': 'When not to use autocertificazione', 'titleIt': 'Quando non usare autocertificazione', 'outputType': 'warning_card', 'contentIt': 'L’autocertificazione non è sempre accettata da soggetti privati o autorità estere. Se il destinatario richiede espressamente un certificato ufficiale, apostille, traduzione o legalizzazione, verifica prima di usare l’autocertificazione.'},
      {'id': 'appointment_checklist', 'title': 'Appointment checklist', 'titleIt': 'Checklist appuntamento Anagrafe', 'outputType': 'checklist', 'items': ['Choose correct service', 'Book through Comune appointment service if required', 'Bring identity document', 'Bring codice fiscale', 'Bring protocol number if existing practice', 'Bring all procedure-specific documents', 'Verify address, office, date and time', 'Check whether appointment is in person or remote']},
      {'id': 'email_appointment_help', 'title': 'Email asking appointment help', 'titleIt': 'Email richiesta aiuto appuntamento', 'outputType': 'email', 'sendTo': 'info.anagrafe@comune.torino.it', 'templateIt': 'Oggetto: Richiesta informazioni per appuntamento Anagrafe\n\nBuongiorno,\n\nvorrei prenotare un appuntamento per [tipo servizio], ma ho bisogno di capire quale sportello/procedura scegliere.\n\nLa mia situazione è la seguente:\n[descrivere brevemente]\n\nHo disponibili i seguenti documenti:\n[elenco]\n\nChiedo cortesemente indicazioni su come prenotare correttamente e cosa portare.\n\nCordiali saluti,\n[Nome Cognome]\n[Telefono]'},
      {'id': 'comune_pec_template', 'title': 'Comune PEC template', 'titleIt': 'Modello PEC Comune', 'outputType': 'pec', 'sendTo': 'Servizi.Civici@cert.comune.torino.it', 'templateIt': 'Oggetto: Richiesta formale - [tipo pratica]\n\nBuongiorno,\n\ncon la presente chiedo informazioni / intervento / verifica in merito a [tipo pratica], relativa a [descrizione breve].\n\nDati pratica, se disponibili:\n- Protocollo: [numero]\n- Data presentazione: [data]\n- Servizio interessato: [Anagrafe / altro]\n\nDescrizione richiesta:\n[spiegare chiaramente]\n\nAllego la documentazione disponibile:\n[elenco allegati]\n\nResto in attesa di riscontro.\n\nCordiali saluti,\n[Nome Cognome]\nCodice fiscale: [codice fiscale]\nTelefono: [telefono]\nEmail: [email]'},
      {'id': 'technical_issue_report', 'title': 'Technical issue report', 'titleIt': 'Segnalazione problema servizio online', 'outputType': 'email', 'sendTo': 'info.anagrafe@comune.torino.it', 'templateIt': 'Oggetto: Segnalazione problema servizio online Comune/Anagrafe\n\nBuongiorno,\n\nsegnalo un problema con il servizio online [nome servizio].\n\nDettagli:\n- Data e ora del problema: [data/ora]\n- Metodo di accesso: [SPID/CIE/CNS]\n- Browser/dispositivo: [browser/dispositivo]\n- Messaggio di errore: [testo errore]\n- Protocollo, se presente: [numero]\n\nAllego screenshot del problema.\n\nChiedo cortesemente indicazioni su come procedere.\n\nCordiali saluti,\n[Nome Cognome]\n[Telefono]'},
      {'id': 'short_information_request_email', 'title': 'Short information request email', 'titleIt': 'Email breve richiesta informazioni', 'outputType': 'email', 'sendTo': 'info.anagrafe@comune.torino.it', 'templateIt': 'Oggetto: Richiesta informazioni Anagrafe\n\nBuongiorno,\n\nvorrei chiedere informazioni sulla procedura corretta per il mio caso.\n\nDescrizione breve:\n[spiegare situazione]\n\nVorrei sapere quale servizio devo usare, se è necessario appuntamento e quali documenti devo preparare.\n\nCordiali saluti,\n[Nome Cognome]\n[Telefono]'},
    ],
    'routingRules': [
      {'if': {'need_type': 'not_sure'}, 'routeTo': 'understand_residenza_domicilio_temporary'},
      {'if': {'need_type': 'move_to_torino'}, 'routeTo': 'change_residence_from_another_comune_or_abroad'},
      {'if': {'need_type': 'move_inside_torino'}, 'routeTo': 'change_address_inside_torino'},
      {'if': {'need_type': 'temporary_stay'}, 'routeTo': 'temporary_residence_popolazione_temporanea'},
      {'if': {'need_type': 'residenza_rejected'}, 'routeTo': 'rejected_residenza_request_reply'},
      {'if': {'need_type': 'certificate_general'}, 'routeTo': 'anagrafe_certificate_request'},
      {'if': {'need_type': 'stato_famiglia'}, 'routeTo': 'family_status_certificate'},
      {'if': {'need_type': 'residence_certificate'}, 'routeTo': 'residence_certificate'},
      {'if': {'need_type': 'self_certification'}, 'routeTo': 'self_certification_autocertificazione'},
      {'if': {'need_type': 'appointment'}, 'routeTo': 'book_anagrafe_appointment'},
      {'if': {'need_type': 'formal_pec'}, 'routeTo': 'pec_formal_request_comune'},
      {'if': {'need_type': 'online_problem'}, 'routeTo': 'online_comune_service_problem'},
      {'if': {'need_type': 'doorbell_address_proof'}, 'routeTo': 'doorbell_mailbox_address_proof'},
      {'if': {'need_type': 'general_information'}, 'routeTo': 'general_comune_information_request'},
      {'if': {'origin': 'inside_torino', 'already_resident_torino': 'yes'}, 'routeTo': 'change_address_inside_torino'},
      {'if': {'origin': 'another_italian_comune'}, 'routeTo': 'change_residence_from_another_comune_or_abroad'},
      {'if': {'origin': 'abroad'}, 'routeTo': 'change_residence_from_another_comune_or_abroad'},
      {'if': {'certificate_recipient': 'public_office'}, 'routeTo': 'self_certification_autocertificazione', 'note': 'For many Italian public offices, autocertificazione may be enough; show warning and allow user to continue to certificate if needed.'},
    ],
  });
...
const Map<String, String> _procedureToSubcategory = {
  'UNDERSTAND_RESIDENZA_DOMICILIO_TEMPORARY': 'understand_residenza_domicilio_temporary',
  'CHANGE_RESIDENCE_FROM_ANOTHER_COMUNE_OR_ABROAD': 'change_residence_from_another_comune_or_abroad',
  'CHANGE_ADDRESS_INSIDE_TORINO': 'change_address_inside_torino',
  'TEMPORARY_RESIDENCE_POPOLAZIONE_TEMPORANEA': 'temporary_residence_popolazione_temporanea',
  ...
  'SELF_CERTIFICATION_AUTOCERTIFICAZIONE': 'self_certification_autocertificazione',
