...
class LocalPrivacyCenterService {
  ...
  static const trackedKeys = [
    ...
    'italy_life_admin_telegram_handoffs_v1',
    'italy_life_admin_official_links_overrides_v1',
    'italy_life_admin_admin_config_v1',
    'ufficcio_entitlement_v1',
    'ufficiofacile_premium_config_v1',
    'ufficiofacile_plan_products_v1',
    'ufficiofacile_content_unlocks_v1',
    'connected_situation_scans_v1',
    'connected_checklist_items_v1',
    'connected_deadlines_v1',
    'connected_saved_procedures_v1',
    'connected_cost_items_v2',
    'ufficio_problem_requests_v1',
    'ufficio_consultancy_requests_v1',
    'ufficio_cost_items_v1',
    'ufficio_directory_contacts_v1',
    'ufficio_documents_v2',
    'ufficio_notification_preferences_v1',
  ];
